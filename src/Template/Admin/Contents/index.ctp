...
<div id="content">
  <div class="inner">
    <div class="row">
      <div class="col-lg-12">
        <h2> <?php echo  __('CMS PAGES LIST') ?> </h2>
      </div>
    </div>
    <hr />
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading"> <?php echo  __('CMS PAGES LIST') ?> </div>
              ...
              <table class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <th style="width: 45%"><?php echo $this->Paginator->sort('page_title') ?></th>
                    <th style="width: 45%"><?php echo $this->Paginator->sort('page_slug') ?></th>
