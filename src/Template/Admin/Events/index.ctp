                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:25%;"><?php echo $this->Paginator->sort('club_name') ?></th>
                                                    <th style="width:25%;"><?php echo $this->Paginator->sort('location') ?></th>
                                        ...
                                        <?php $i = 1; foreach ($category as $dt): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo($dt['Users']['club_name']); ?></td>
                                                    <td><?php echo h($dt->location) ?></td>
                                                    <!---
