							...
							<div class="col-lg-10">
								<form method="post" action="<?php echo $this->Url->build(["controller" => "Services","action" => "editservice",$service->id]);?>" enctype='multipart/form-data'>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
                                                                                    <input type="text" class="form-control"  name="service_name" value="<?php echo $service->service_name; ?>">
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-8">
                                                                                    <select class="form-control" name='venue_type_id'>
                                                                                        ...
                                                                                        <?php foreach ($stname as $dt) { ?>
                                                                                            <option value='<?php echo $dt->id; ?>' <?php if($service->venue_type_id== $dt->id){echo "selected";}?>><?php echo $dt->type_name; ?></option>
                                                                                        <?php } ?>
                                                                                    </select>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<textarea class="form-control" rows="4" name="description"><?php echo $service->description; ?></textarea>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
                                                                                    <input type="text" class="form-control" name="cp_fname" value="<?php echo $service->cp_fname; ?>">
										</div>
									</div>
									<div class="form-group row">
										<label for="staticEmail" class="col-sm-4 col-form-label">Last Name:</label>
										<div class="col-sm-8">
                                                                                    <input type="text" class="form-control" name="cp_lname" value="<?php echo $service->cp_lname; ?>">
										</div>
									</div>
									<div class="form-group row">
										<label for="staticEmail" class="col-sm-4 col-form-label">Email Address:</label>
										<div class="col-sm-8">
                                                                                    <input type="email" class="form-control" name="cp_email" value="<?php echo $service->cp_email; ?>">
										</div>
									</div>
									<div class="form-group row">
										<label for="staticEmail" class="col-sm-4 col-form-label">Phone Number:</label>
										<div class="col-sm-8">
                                                                                    <input type="text" class="form-control" name="cp_phone" value="<?php echo $service->cp_phone; ?>">
										</div>
									</div>
									<div class="row">
