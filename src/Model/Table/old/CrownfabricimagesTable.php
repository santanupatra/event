 ...
 */
class CrownfabricimagesTable extends Table {
    ...
    public function initialize(array $config) {
        ...
        $this->table('crownfabricimages');
        //$this->displayField('name');
        $this->primaryKey('id');
        
        
        //$this->belongsTo('Parent', ['className' => 'Treatments', 'foreignKey' => 'parent_id', 'propertyName' => 'Treatments' ]);
        $this->belongsTo('Crownfabrications', ['className' => 'Crownfabrications', 'foreignKey' => 'crown_id', 'propertyName' => 'Crownfabrications' ]);
