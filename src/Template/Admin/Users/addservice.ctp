				...
				<?php echo $this->Form->create($service,['class' => 'form-horizontal', 'id' => 'user-validate', 'enctype' => 'multipart/form-data']);?>
                             ...
                             <div><h3><b>Timing</b></h3></div><br>  
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text"  name="max_occupancy" class="form-control">
                                    </div>
                              </div>
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text"  name="square_footage"  class="form-control">
                                    </div>
                              </div>
                              ...
                              <div><h3><b>Venue Features</b></h3></div><br> 
                                    ...
                                    <div class="col-lg-8"> 
                                        <?php foreach($eventname as $dt)
                                            { ?>
                                                <div class="col-lg-1">
                                                    <input type="checkbox" name="event_id[]" value="<?php echo $dt->id; ?>">
                                                </div>
                                                <div class="col-lg-7">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-lg-8"> 
                                        <?php foreach($amenityname as $dt)
                                            { ?>
                                                <div class="col-lg-1">
                                                    <input type="checkbox" name="amenity_id[]" value="<?php echo $dt->id; ?>">
                                                </div>
                                                <div class="col-lg-7">
...
<!--                              <div class="form-group">
                              ...
                              <div class="form-group"> 
                                ...
                                <div class="col-lg-8" style="text-align:left;"> 
                                    <input type="submit" name="submit" value="Add Venue" class="btn btn-primary" />
                                </div>
