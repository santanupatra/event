                                ...
                                <div id="div-1" class="accordion-body collapse in body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input name="tags" id="tags" value="foo,bar,baz,sdou" class="form-control" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="box">
                                <header>
                                    ...
                                    <div class="toolbar">
                                        <input class="uniform" type="checkbox" checked="checked" />
                                    </div>
                                </header>
                                <div class="body">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="checkbox">
                                                    <label>
                                                        <input class="uniform" type="checkbox" value="option1" checked="checked" /> Checked checkbox
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input class="uniform" type="checkbox" value="option3" checked="checked" disabled="disabled" /> Disabled
                                                        checked
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                    <label>
                                                        <input class="uniform" type="checkbox" value="option2" disabled="disabled" /> Disabled unchecked
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="checkbox">
                                                    <label>
                                                        <input class="uniform" type="radio" name="optionsRadios" value="option1" checked="checked" />Checked
                                                        radio
                                                    </label>
                                                </div>
                                                <div class="checkbox">
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input class="uniform" type="radio" name="optionsRadios2" value="option3" checked="checked"
                                                               disabled="disabled" />
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input class="uniform" type="radio" name="optionsRadios2" value="option4" disabled="disabled" />
                                ...
                                <div id="div-2" class="accordion-body collapse in body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <select data-placeholder="Your Favorite Football Team" class="form-control chzn-select" multiple="multiple" tabindex="6">
                                                    <optgroup label="NFC EAST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <select data-placeholder="Your Favorite Types of Bear" multiple class="form-control chzn-select"
                                                        id="test_me_paddington" name="test_me_form" tabindex="8">
                                                    <option>American Black Bear</option>
                                                    <option>Asiatic Black Bear</option>
                                                    <option>Brown Bear</option>
                                                    <option>Giant Panda</option>
                                                    <option selected="selected" disabled="disabled" >Sloth Bear</option>
                                                    <option disabled="disabled">Sun Bear</option>
                                                    <option selected="selected" disabled="disabled">Paddington Bear</option>
                                                    <option selected="selected">Polar Bear</option>
                                                    <option disabled="disabled">Spectacled Bear</option>
                                                </select>
                                            </div>
