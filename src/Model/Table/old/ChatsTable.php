...
class ChatsTable extends Table {
    ...
    public function initialize(array $config) {
        ...
        $this->belongsTo('sender', ['className' => 'Users', 'foreignKey' => 'sender_id', 'propertyName' => 'sender' ]);
        $this->belongsTo('receiver', ['className' => 'Users', 'foreignKey' => 'receiver_id', 'propertyName' => 'receiver' ]);
