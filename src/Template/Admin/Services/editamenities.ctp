                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="first_name" name="amenities_name" class="form-control" value="<?php echo $user->amenities_name ?>"/>
                                    </div>
                                </div>  
                                ...
                                <div class="col-lg-8" style="text-align:left;"> 
                                    <input type="submit" name="submit" value="Edit Amenities" class="btn btn-primary" />
                                </div>
