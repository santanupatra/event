 ...
 */
class CrownfabricationsTable extends Table {
    ...
    public function initialize(array $config) {
        ...
        $this->table('crownfabrications');
        //$this->displayField('name');
        $this->primaryKey('id');
        
        
        //$this->belongsTo('Parent', ['className' => 'Treatments', 'foreignKey' => 'parent_id', 'propertyName' => 'Treatments' ]);
        $this->belongsTo('Users', ['className' => 'Users', 'foreignKey' => 'doctor_id', 'propertyName' => 'Users' ]);
        $this->belongsTo('Patient', ['className' => 'Users', 'foreignKey' => 'user_id', 'propertyName' => 'Patient' ]);
       $this->hasMany('Crownfabricimages', ['className' => 'Crownfabricimages', 'foreignKey' => 'crown_id', 'propertyName' => 'Crownfabricimages' ]);
